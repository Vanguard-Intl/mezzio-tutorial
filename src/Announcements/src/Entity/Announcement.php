...
/**
 * https://www.doctrine-project.org/projects/doctrine-orm-module/en/3.1.x/configuration.html#configuration
 *
 * @ORM\Entity
...
class Announcement
{
    ...
    public function setAnnouncement(array $requestBody) : void {
        $this->setSort((int)$requestBody['sort']);
        $this->setContent((string)$requestBody['content']);
